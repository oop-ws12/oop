...
public class Main {
	...
	public static void EventTest(MusikGruppe grp) throws ParseException {
		...
		grp.newEvent(new Auftritt("Wien", format.parse("03.10.1991"),
				format.parse("03.11.1991 00:00"), 12.00));

		grp.newEvent(new Probe("Wopfing", format.parse("05.01.1991"),
				format.parse("06.01.1991 00:00"), 12.00));

		grp.newEvent(new Probe("Wopfing", format.parse("05.04.1991"),
				format.parse("06.04.1991"), 12.00));
